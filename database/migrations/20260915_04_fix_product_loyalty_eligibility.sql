-- ================================================================
-- INC-LOY-02A
-- Corregir elegibilidad de PRODUCT para fidelización
--
-- Regla funcional:
--   - Todo PRODUCT aporta monetariamente al acumulado diario.
--   - CUSTOM conserva su elegibilidad explícita Sí/No.
--
-- Corrige create_local_sale_with_order_v2 para eliminar la
-- dependencia de products.generates_stamps en líneas PRODUCT.
-- ================================================================
