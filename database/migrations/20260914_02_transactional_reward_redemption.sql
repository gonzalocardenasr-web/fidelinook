-- ================================================================
-- DEV-LOY-RED-01B.2
-- Canje transaccional de rewards integrado a la venta
--
-- Nueva versión de la RPC de venta que incorpora:
--   p_reward_id
--   p_actor_identifier
--
-- La RPC productiva anterior se mantiene temporalmente para permitir
-- un cutover sin downtime. Se retirará después de validar V2.
-- ================================================================
