      ...
      <POSLayout
        ...
        center={
          <div
            className={
              configuringProduct
                ? "grid h-full min-h-0 min-w-0 grid-cols-[minmax(240px,0.9fr)_minmax(300px,1.1fr)] gap-2 overflow-hidden"
                : "grid h-full min-h-0 min-w-0 grid-cols-1 gap-2 overflow-hidden"
            }
          >
            <ProductGrid
        ...
        right={
          <OrderBuilder
            ...
            manualDiscountNotes={manualDiscountNotes}
